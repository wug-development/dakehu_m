...
<div id="ReturnFlight" class="returnflight-box">
    <Header class="flight-header" bgcolor="inherit" :name="pageTitle"></Header>
        ...
        <div class="flist-body">
            <ul class="flist-list">
                <li class="flist-item" v-for="(titem, index) in backList" :key="index">
                    <div v-for="(item, i) in titem" :key="i" :class='i!=0?"itemboxs":"itembox"' v-show="i == 0 || index == othernum">
                        <div class="lab">
                            <div class="labs">
                            ...
                            <div class="btnprice">
                                ...
                                <a v-if="index != 0" @click="selFlight(item.AirID, index)">预定</a>
                            </div>
                        </div>
                        <div @click="selFlight(item.AirID, index)">
                            <div class="info">
                                <div class="info-go">
